...
<head>
    <title>Faire + Acheter - | Miam - Sauce fajitas en conserve</title>
    ...
    <main role="main">
        ...
        <div class="container">
            <div class="card text-white">
                <img src="../../img/fajitasico.jpg" alt="fajitas" class="card-img" />
            </div>

            <div class="card">
                <div class="card-body">
                    <h2 class="card-title display-4 text-center">Sauce fajitas en conserve</h2>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item"> Sel <br/> <span class="text-muted"> 2 cuillères à soupe au moins</span></li>
                                <li class="list-group-item"> Concentré de tomates bio <br/> <span class="text-muted"> 2 petits bocaux</span></li>
                                <li class="list-group-item"> Huile de tournesol désodorisée<br/> <span class="text-muted"> 2 cuillères à soupe</span></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-md-8 ">
                    ...
                    <div class="card ">
                        ...
                        <div class="card-header ">
                            Préparation :<span class="float-right fa fa-clock-o "> 4h</span>
                        </div>

                        <div class="card-body ">
                            <p class="card-text">J’épluche et j’épépine les tomates. Si j’ai pris soin de bien les choisir, en évitant les tomates grappes sans chair et sans goût, et en préférant des variétés plus chères mais très généreuses comme les rose de Berne, noires de Crimée, vraies coeur de boeuf, marmande, etc, je n’ai presque pas besoin d’épépiner -l’épluchage, long, est pourtant indispensable.</p>
                            <p class="card-text">J’émince tous les autres légumes.</p>
                            <p class="card-text">Dans la bassine à confiture, je fais revenir l’oignon dans l’huile, puis j’ajoute l’ail et le poivron, et ensuite le piment, puis les tomates et tous les autres ingrédients.</p>
                            <p class="card-text">Je laisse sur le feu à petits bouillons le temps de faire réduire en sauce (environ 40mn). Je rectifie éventuellement l’assaisonnement.</p>
