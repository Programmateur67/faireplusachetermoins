...
<head>
    <title>Faire + Acheter - | Glou - Eau gazeuse</title>
    ...
    <main role="main">
        ...
        <div class="container">
            <div class="card text-white">
                <img src="../../img/Eaugazeuseico.JPG" alt="eau gazeuse" class="card-img" />
            </div>

            <div class="card">
                <div class="card-body">
                    <h2 class="card-title display-4 text-center">Eau gazeuse</h2>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="d-none d-sm-block">
                        ...
                        <div class="card">
                            <img src="../../img/Eaugazeuse(1).JPG" alt="eau gazeuse" class="card-img" />
                        </div>
